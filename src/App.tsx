...
const App = () => {
  ...
  if (screen === 'title') {
    return (
      <>
        <div className="fixed top-0 left-0 right-0 bg-yellow-400 text-black text-[10px] font-bold text-center z-[9999] py-1 shadow-md">
          DEBUG: SAFE-AREA-V10.1 (80PX + BLACK BAR)
        </div>
        <div
  ...
  return (
    <>
      ...
      >
        ...
        <div
          className="fixed bottom-0 left-0 right-0 p-4 pb-[calc(1rem+var(--safe-bottom))] bg-gradient-to-t from-bg via-bg to-transparent pointer-events-none"
